...
A20SwitchingFailureMessage:	db 'A20 Switching & 64MiB Physical Memory check failure', 0
A20SwitchingSuccessMessage:	db 'A20 Switching & 64MiB Physical Memory check success', 0
